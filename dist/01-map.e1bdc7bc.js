...
module.exports = "/world.cdd9ffc6.topojson";
},{}],"data/world-cities.csv":[function(require,module,exports) {
module.exports = "/world-cities.4b34157e.csv";
...
var colorScale = d3.scaleSequential(d3.interpolateCool).domain([0, 600000]).clamp(true);
...
function ready(_ref) {
  ...
  .enter().append('path').attr('class', 'country').attr('d', path).attr('fill', 'black');

  // adding dots for each city
  svg.selectAll('.city').data(datapoints).enter().append('circle').attr('class', 'city').attr('r', 1).attr('transform', function (d) {
  ...
  svg.append('path').datum(graticule()).attr('d', path).attr('stroke', 'grey').attr('opacity', 0.5).lower();
}
},{"d3":"../node_modules/d3/index.js","topojson":"../node_modules/topojson/index.js","./data/world.topojson":"data/world.topojson","./data/world-cities.csv":"data/world-cities.csv"}],"../../../../.npm-global/lib/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../../.npm-global/lib/node_modules/parcel/src/builtins/hmr-runtime.js","01-map.js"], null)
//# sourceMappingURL=/01-map.e1bdc7bc.map